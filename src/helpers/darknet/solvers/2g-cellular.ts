...
const PROGRESS_FILE = '/helpers/darknet/2g-cellular-progress.json';
...
export async function solve2GCellular(ns: NS, hostname: DarknetHostname): Promise<DarknetSolverResult> {
