...
const PROGRESS_FILE = '/helpers/darknet/big-mo-od-progress.json';
...
export async function solveBigMoOd(ns: NS, hostname: DarknetHostname): Promise<DarknetSolverResult> {
