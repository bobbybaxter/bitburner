...
const PROGRESS_FILE = '/helpers/darknet/king-of-the-hill-progress.json';
...
export async function solveKingOfTheHill(ns: NS, hostname: DarknetHostname): Promise<DarknetSolverResult> {
