...
export class Heap<T> {
   ...
   */
  constructor(compare: (a: T, b: T) => number, _values?: T[], _leaf?: T | null) {
   ...
   * @private
   */
  _hasLeftChild(parentIndex: number): boolean {
   ...
   * @private
   */
  _hasRightChild(parentIndex: number): boolean {
   ...
   * @private
   */
  _compareAt(i: number, j: number): number {
   ...
   * @private
   */
  _shouldSwap(parentIndex: number, childIndex: number): boolean {
   ...
   * @private
   */
  _compareChildrenOf(parentIndex: number): number {
   ...
   * @private
   */
  _compareChildrenBefore(index: number, leftChildIndex: number, rightChildIndex: number): number {
   ...
   * @private
   */
  _heapifyUp(startIndex: number): void {
   ...
   * @private
   */
  _heapifyDown(startIndex: number): void {
   ...
   * @private
   */
  _heapifyDownUntil(index: number): void {
    let parentIndex = 0;
   ...
   * @returns {Heap}
   */
  static heapify<T>(values: T[], compare: (a: T, b: T) => number): Heap<T> {
   ...
   * @returns {boolean}
   */
  static isHeapified<T>(values: T[], compare: (a: T, b: T) => number): boolean {
