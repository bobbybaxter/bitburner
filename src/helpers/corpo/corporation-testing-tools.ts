...
import { EmployeePosition, MaterialName, ResearchName, UpgradeName } from '/helpers/corpo/corporation-formulas';
import { cities } from '/helpers/corpo/corporation-utils';
