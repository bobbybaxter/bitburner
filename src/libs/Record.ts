// https://raw.githubusercontent.com/bitburner-official/bitburner-src/dev/src/Types/Record.ts
...
export const getRecordValues = Object.values as <V>(record: PartialRecord<string, V>) => V[];

/** Get a keys array with proper type. Object.keys by default returns string[] */
export const getRecordKeys = Object.keys as <K extends string>(record: PartialRecord<K, string>) => K[];
