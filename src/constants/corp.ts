export const DEFAULT_MIN_FOR_NORMALIZATION = 5;
export const DEFAULT_MAX_FOR_NORMALIZATION = 200;
export const REFERENCE_VALUE_MODIFIER = 10;
export const WAREHOUSE_UPGRADE_BASE_PRICE = 1e9;
